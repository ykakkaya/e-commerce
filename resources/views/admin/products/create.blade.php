                            ...
                            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="inputState" class="form-select" name="child_category_id">
                                                <option value="">Child Kategori Seçiniz</option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-select" name="product_type">
                                        ...
                                        <option value="featured_product">Öne Çıkan Ürün</option>
                                        <option value="top_product">En Çok Satan Ürün</option>
                                        <option value="best_product">En İyi Ürün</option>
                                    </select>
                                    @error('product_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <button type="submmit" class="btn btn-primary">Ekle</button>
                            </form>
                        </div>
